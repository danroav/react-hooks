...
useEffect should be used for time consuming tasks

state should be lifted to common parent component

slice(0,lenght) creates a copy from 0 to length not inclusive
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=a%40b.c).
