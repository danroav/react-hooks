...
useState has a default value in the setup

React component parameters can be received by name or spread components.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=a%40b.c).
